...
const pool = new Pool({
    connectionString: process.env.DATABASE_URL || 'postgresql://fpl_ppj0_user:pVVJT6yzEllocA418PPJa8QrhS2roRQw@dpg-crgagprv2p9s73' +
            'aaeql0-a.frankfurt-postgres.render.com/fpl_ppj0',
    ssl: {
